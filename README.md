...
Sie können dieses JupyterBook zu Lehr- und Lernzwecken verwenden. Sie können sie zudem teilen und bearbeiten unter der Bedingung der Nennung der Autor:innen und der gleichen Lizenzierung. Weitere Informationen dazu entnehmen Sie bitte den <a href="https://github.com/quadriga-dk/Bewegtes-Bild-Fallstudie-3/blob/main/LICENSE.md" target="_blank">Lizenzhinweisen</a>.  

## Inhalt der OER

Dieses interaktive Lehrbuch vermittelt Strategien, Arbeitsprozesse und Verfahren zur Anreicherung, Aufbereitung und Publikation filmwissenschaftlicher Forschungsdaten auf Repositorien.

Nach einer grundlegenden Einführung werden anhand praxisnaher Beispiele aus einem konkreten Forschungsprojekt nachvollziehbare Schritte aufgezeigt, wie bestehende Datensätze – etwa Annotationsdatensets – systematisch, standardkonform und qualitätsgesichert aufbereitet, bereinigt und beispielsweise durch Moviebarcodes angereichert werden können. Im Anschluss wird die konkrete Umsetzung der Veröffentlichung auf öffentlichen Repositorien praxisorientiert erläutert.
...
Bei Fragen zum Projekt wenden Sie sich gerne an die [Projektkoordination](mailto:derya.demir@fu-berlin.de?subject=[GitHub]%20Feedback%20Bewegtes-Bild-Fallstudie-3).

...
<table class="modern-table">
  ...
  <tbody>
    ...
    <tr>
      <td><strong>2. Befragungs- und Beobachtungsdaten</strong></td>
      <td>
        <ul>
          <li>Interviews, Umfragen, Fragebögen</li>
          <li>Feldnotizen, ethnografische Beobachtungen</li>
          <li>Audioaufnahmen oder Videomaterial aus Feldstudien</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td><strong>3. Bild-, Audio- und Videodateien</strong></td>
      <td>
        <ul>
          <li>Fotografien, Scans, Filmaufnahmen</li>
          <li>Mikroskopische und astronomische Bilder</li>
          <li>Animations- oder Motion-Capture-Dateien</li>
          <li>Audiospuren</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td><strong>4. Dokumentarische oder textbasierte Dateien</strong></td>
      <td>
        <ul>
          <li>Manuskripte, Briefe, historische Dokumente</li>
          <li>Archivalien, Transkripte</li>
          <li>Codebücher, Annotationsdateien, Metadaten</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td><strong>5. Computergenerierte Daten / digitale Objekte</strong></td>
      <td>
        <ul>

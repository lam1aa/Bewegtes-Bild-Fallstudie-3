...
```{admonition} Rechtliche Vorgaben
:class: important
Dies ist insbesondere vor dem Hintergrund unterschiedlicher rechtlicher Vorgaben relevant. Die Verbreitung oder Vervielfältigung von Bild- und Filmmaterial unterliegt oftmals dem Urhebergesetz und muss sorgfältig geprüft werden. Gleiches gilt für personenbezogene Angaben. Weitere Informationen zu rechtlichen Vorgaben finden sich in unserer <a href="https://quadriga-dk.github.io/Bewegtes-Bild-Fallstudie-2/publikation/problemfelder.html" class="external-link" target="_blank">QUADRIGA Fallstudie: "Studentische Filme an der Filmuniversität Babelsberg zur Wendezeit (1985-1999)"</a>
```
...
::::{tab-set}
:::{tab-item} 🎞️ Primärdaten
- **Filme und Filmausschnitte** – analoge oder digitale Originalwerke
...
Die Auseinandersetzung um die Beschaffenheit und Nutzung von Forschungsdaten ist insbesondere dann relevant, wenn die Prozesshaftigkeit der Wissensproduktion mitgedacht wird: woher kommen die Daten? Wie werden sie erhoben und aufbereitet? Wie werden sie kuratiert und verfügbar gemacht? Ferner sollte es auch immer eine kritische Auseinandersetzung über die Entstehung von Forschungsdaten und -ergebnissen geben. Denn Daten können, je nach Kontext, Biases unterliegen. Ein Anspruch auf Objektivität ist daher nicht einlösbar {cite}`{vgl.}dang_forschungsdatenmanagement_2020`.
Ein repräsentatives Beispiel ist die weltweit größte Filmdatenbank <a href="https://www.imdb.com/de/" class="external-link" target="_blank">IMDb</a>, deren Inhalte kommerziell von Amazon betrieben und gepflegt werden.
Die Datenanforderungen sowie die Auswahl und Gewichtung der Inhalte sind dabei von geschlechtsspezifischen und diskriminierenden Inklusions- und Exklusionsmechanismen geprägt. Welche Filme dabei als "gut" oder "schlecht" gerankt werden, hängt von diversen soziopolitischen, ökonomischen aber auch algorithmischen Variablen ab {cite:p}`{vgl.}drucker_digital_humanities_2021,dang_forschungsdatenmanagement_2020`. Ebenso beeinflussen etwa Kritiken, Nutzer:innenbewertungen und Kommentare die Sichtbarkeit bestimmter Filme oder Personengruppen – während andere Perspektiven systematisch marginalisiert werden {cite}`{vgl. hierzu auch}Doughman_Khreich_2025`.[^1]
````{margin}
...
[^1]: Doughman und Khreich analysierten in ihrer Studie 17.165 professionelle Filmkritiken auf geschlechtsspezifische sprachliche Verzerrungen und zeigen, wie diese Kritiken die öffentliche Wahrnehmung von Filmen beeinflussen und zur Marginalisierung von Frauen in der Filmindustrie beitragen können.

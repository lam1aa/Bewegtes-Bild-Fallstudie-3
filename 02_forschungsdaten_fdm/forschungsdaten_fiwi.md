...
Die Datenanforderungen sowie die Auswahl und Gewichtung der Inhalte sind dabei von geschlechtsspezifischen und diskriminierenden Inklusions- und Exklusionsmechanismen geprägt. Welche Filme dabei als "gut" oder "schlecht" gerankt werden, hängt von diversen soziopolitischen, ökonomischen aber auch algorithmischen Variablen ab. Ebenso beeinflussen etwa Nutzer:innenbewertungen und Kommentare die Sichtbarkeit bestimmter Filme oder Personengruppen – während andere Perspektiven systematisch marginalisiert werden. 
````{margin}
